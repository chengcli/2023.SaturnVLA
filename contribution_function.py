...
def plot_contribution_function(ax, case, ang = None):
  ...
  ax.plot(wfunc1, pres, label = 'S band, 2.1 GHz, 14.1 cm')
  ax.plot(wfunc2, pres, label = 'C band, 4.1 GHz, 7.3 cm')
  ax.plot(wfunc3, pres, label = 'X band, 10 GHz, 3 cm')
  ax.plot(wfunc4, pres, label = 'U band, 14 GHz, 2.1 cm')
  ax.plot(wfunc5, pres, label = 'K band, 22 GHz, 1.4 cm')
  ax.plot(wfunc6, pres, label = 'Q band, 43 GHz, 0.7 cm')
